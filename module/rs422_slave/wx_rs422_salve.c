...
/* 发送ADU */
UINT32 WX_RS422I_Slave_SendAdu(WxRs422ISlaveTask *this, WxModbusAdu *txAdu)
{
...
/* 发送异常响应 */
UINT32 WX_RS422I_Slave_SendExcpRsp(WxRs422ISlaveTask *this, WxRs422ISlaveMsg *req, UINT8 excpCode)
{
...
UINT32 WX_RS422I_Slave_ProcReadDataReq(WxRs422ISlaveTask *this, WxModbusAdu *rxAdu, WxRs422ISlaveMsg *req)
{
    UINT32 rc;
    /* 获取读数据的handle */
...
/* 从机处理写数据请求 */
UINT32 WX_RS422I_Slave_ProcWriteDataReq(WxRs422ISlaveTask *this, WxModbusAdu *rxAdu, WxRs422ISlaveMsg *req)
{
    /* 获取写Handle */
    ...
    /* 数据解码 */
    UINT32 rc = handle->decAdu(&this->rxAdu, &req->data);
    if (rc != WX_SUCCESS) {
...
/* 从机处理写文件请求 */
UINT32 WX_RS422I_Slave_ProcReadFileReq(WxRs422ISlaveTask *this, WxModbusAdu *rxAdu, WxRs422ISlaveMsg *req)
{
...
/* 从机处理读文件请求 */
UINT32 WX_RS422I_Slave_ProcWriteFileReq(WxRs422ISlaveTask *this, WxModbusAdu *rxAdu, WxRs422ISlaveMsg *req)
{
...
/* 从机处理接收到ADU */
UINT32 WX_RS422I_Slave_ProcRxAdu(WxRs422ISlaveTask *this, WxModbusAdu *rxAdu)
{
...
UINT32 WX_RS422I_Slave_CreateTask(VOID)
{
    ...
    if (this->msgQueHandle == 0) {
        this->msgQueHandle = xQueueCreate(WX_RS422_MASTER_MSG_ITERM_MAX_NUM, sizeof());
        if (this->msgQueHandle == 0) {
