...
/* CAN 设备配置 */
WxCanDriverCfg g_wxCanSlaveACfg = {

};

/* CAN 设备中断配置 */
WxCanDriverIntrCfg g_wxCanSlaveAIntcCfg = {
...
UINT32 WX_CAN_DRIVER_A_Construct(VOID *module)
{
    ...
    ret = WX_CAN_DRIVER_Constuct(this, &g_wxCanSlaveACfg, &g_wxCanSlaveAIntcCfg);
    if (ret != WX_SUCCESS) {
        WX_Mem_Free(this);
        return ret;
    }
...
UINT32 WX_CAN_DRIVER_A_Entry(VOID *module, WxEvtMsg *evtMsg)
{
