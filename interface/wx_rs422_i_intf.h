...
typedef enum {
    ...
    WX_RS422I_MSG_WRITE_DATA_RSP,   /* 写数据响应, 子类型: WxRs422IWriteDataType, 消息体为：WxR422IWriteDataRsp */
...
/* 读数据成功的响应 */
typedef struct {
    WxFailCode rspCode; /* 读数据的响应码 */
    /*
     * 这里的类型具体是啥由枚举dataType确定
     */
    union { 
