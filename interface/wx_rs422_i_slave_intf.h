 ...
 *****************************************************************************/
typedef enum {
    WX_RS422_SLAVE_EXCP_CODE_OK, /* 成功 */
    WX_RS422_SLAVE_EXCP_CODE_ERR, /* 未知错误 */
...
typedef struct {
    UINT8 funcCode;     /* 功能码 */ 
    UINT8 excpCode;     /* 异常码 - 当功能码为异常码时候有效 */
    UINT16 dataAddr;    /* 数据地址, 由枚举WxRs422ISlaveDataAddr定义 */
    WxRs422ISlaveData data; /* 数据 */
} WxRs422ISlaveMsg;
